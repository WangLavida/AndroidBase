...
import static com.xgs.androidbase.R.*;
...
public class ToastUtil {
    ...
    public static Toast showToastWithImg(final String tvStr, final int imageResource) {
        ...
        View view = LayoutInflater.from(MainApplication.getAppContext()).inflate(layout.toast_custom, null);
        TextView tv = (TextView) view.findViewById(id.toast_custom_tv);
        tv.setText(TextUtils.isEmpty(tvStr) ? "" : tvStr);
        ImageView iv = (ImageView) view.findViewById(id.toast_custom_iv);
        if (imageResource > 0) {
